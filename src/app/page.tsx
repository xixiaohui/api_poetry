...
Chinese Poetry API   AI Service      User Service
  (1279/Docker)     (DeepSeek)      (PostgreSQL)
   ...
   诗词数据库(40万首)                  Redis Cache`}
      ...
      {/* Footer */}
      <footer className="max-w-5xl mx-auto px-6 py-12 border-t border-zinc-200 dark:border-zinc-800 text-center text-sm text-zinc-500 dark:text-zinc-500">
        <p>
          Poetry Gateway · Built with Next.js 16 · Data from{" "}
          <a
